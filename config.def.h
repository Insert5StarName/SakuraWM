...
static const int barheight          = 2;        /* SakuraPatch: Increase/Decrease height of the Bar Default: 2 */
static const int splitstatus        = 1;        /* SakuraPatch: 1 for split status items */
static const char hidestatus[]      = "n/a";    /* SakuraPatch: Hide Status if status contains this string */
static const char *splitdelim       = ";";      /* SakuraPatch: Character used for separating status */
/* Fonts: Recommend "JetBrainsMono Nerd Font" */
...
/* SakuraPatch: GruvBox ColorScheme */
...
/* SakuraPatch: Only One Layout other layouts have been removed as they are not neccesary */
...
static const char *termcmd[]  = { "SakuraTerm", NULL };
static Key keys[] = {
    ...
    { MODKEY,                       XK_x,      spawn,          SHCMD("$HOME/screnshot.sh") },
    { MODKEY,                       XK_a,      spawn,          SHCMD("thunar") },
    { MODKEY|ShiftMask,             XK_d,      spawn,          SHCMD("pavucontrol") },
...
static Button buttons[] = {
    ...
    /* SakuraPatch: Middle Part of the Bar (where the window title was supposed to be) */
	{ ClkMiddleStatusText,  0,              Button1,        spawn,          SHCMD("playerctl play-pause") },
